...
function EchoPromptModal({ nodeId }: { nodeId: string }) {
  ...
  return (
    <div className="np-glass rounded-lg w-[520px] max-w-full p-6 border-[var(--color-cyan-dim)] np-glow-cyan">
...
function IdleResumeModal({ idleSeconds }: { idleSeconds: number }) {
  ...
  return (
    <div className="np-glass rounded-lg w-[480px] max-w-full p-6 border-[var(--color-amber)] shadow-[0_0_24px_color-mix(in_oklab,var(--color-amber)_30%,transparent)]">
      <div className="flex items-center gap-2">
...
function SessionEndModal({
  ...
  return (
    <div className="np-glass rounded-lg w-[480px] max-w-full p-6 border-[var(--color-cyan-dim)] np-glow-cyan">
...
function LevelUpModal({ oldLevel, newLevel }: { oldLevel: number; newLevel: number }) {
  ...
  return (
    <div className="np-glass rounded-lg w-[460px] max-w-full p-7 border-[var(--color-magenta-dim)] np-glow-magenta">
      <div className="flex items-center gap-2">
...
function AchievementModal({
  ...
  return (
    <div className="np-glass rounded-lg w-[440px] max-w-full p-6 border-[var(--color-amber)] shadow-[0_0_28px_color-mix(in_oklab,var(--color-amber)_35%,transparent)]">
      <div className="flex items-center gap-2">
...
function DailyBriefingModal() {
  ...
  return (
    <div className="np-glass rounded-lg w-[560px] max-w-full p-6 border-[var(--color-cyan-dim)]">
...
function Stat({ label, value, color }: { label: string; value: string; color: string }) {
  return (
    <div className="np-glass rounded px-3 py-2.5">
