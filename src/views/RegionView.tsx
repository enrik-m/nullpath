...
export function RegionView({ regionId }: RegionViewProps) {
  ...
  // ZONE_PARENTS is still authoritative for unlock logic in
  // isZoneUnlocked() — we just don't visualize the dependency graph,
  // because the resulting tangle (Z23 alone has 8 parents) was
  // unreadable. New operators get a single "follow this path" line
  // instead of the spider-web of dependencies.
  const edges = useMemo(() => {
