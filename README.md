...
> _Generated by `npm run capture:screenshots` (see Scripts table)._
> _The captures land in `docs/screenshots/`; this section references
> them by relative path so they render on GitHub._
